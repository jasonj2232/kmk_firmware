...
keyboard.keymap = [
    ...
    [
        ...
        _______, KC.BT_CLR, KC.BT_PRV, KC.BT_NXT,    _______,      _______, _______,_______, _______, _______, _______,  _______, _______, _______, _______,         KC.UP,
                 _______,   _______,                 _______,      _______, _______,                           _______,                             _______, KC.LEFT,KC.DOWN, KC.RGHT,    KC.MPLY
    ]
]

if __name__ == '__main__':
    keyboard.go(hid_type=HIDModes.BLE, ble_name='Ishi80 Mk0')